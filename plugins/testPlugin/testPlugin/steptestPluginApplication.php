...
try {
  ...
  $oHeadPublisher->addContent("testPlugin/steptestPluginApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("testPlugin/steptestPluginApplication", false); //Adding a javascript file .js
