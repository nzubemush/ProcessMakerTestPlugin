...
try {
  ...
  $oHeadPublisher->addContent("mosheTest/stepmosheTestApplication"); //Adding a html file .html.
  $oHeadPublisher->addExtJsScript("mosheTest/stepmosheTestApplication", false); //Adding a javascript file .js
