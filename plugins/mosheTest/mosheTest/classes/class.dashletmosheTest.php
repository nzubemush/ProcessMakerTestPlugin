...
class dashletmosheTest implements DashletInterface
{
  const version = '1.0';
  ...
  public function render($width = 300)
  {
    ...
    ///////
    $dashletView = new dashletmosheTestView($arrayUser, $this->note);
...
class dashletmosheTestView extends Smarty
{
  private $smarty;
  ...
  public function __construct($u, $n)
  {
    ...
    $this->smarty->templateFile = PATH_PLUGINS . "mosheTest" . PATH_SEP . "views" . PATH_SEP . "dashletmosheTest.html";
  }
