...
foreach ($G_TMP_MENU->Id as $index => $value) {
  if ($index == 3) { //Option CASES_INBOX
    $tmpId[$index + $k]      = "ID_MOSHETEST_MNUCASE_01";
    $tmpTypes[$index + $k]   = "plugins";
    $tmpEnabled[$index + $k] = 1;
    $tmpOptions[$index + $k] = "../mosheTest/mosheTestApplication"; //link
    $tmpLabels[$index + $k]  = "Application";
    $tmpJS[$index + $k]      = null;
...
$tmpId[$i]      = "ID_MOSHETEST_MNUCASE_02";
...
$tmpId[$i]      = "ID_MOSHETEST_MNUCASE_03";
$tmpTypes[$i]   = "plugins";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "../mosheTest/mosheTestApplication2"; //link
$tmpLabels[$i]  = "documentation";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
...
$tmpId[$i]      = "ID_MOSHETEST_MNUCASE_04";
$tmpTypes[$i]   = "blockHeader";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = null; //link
$tmpLabels[$i]  = "Library";
...
$tmpId[$i]      = "ID_MOSHETEST_MNUCASE_05";
$tmpTypes[$i]   = "plugins";
$tmpEnabled[$i] = 1;
$tmpOptions[$i] = "https://www.google.com/"; //link
$tmpLabels[$i]  = "calculation";
$tmpJS[$i]      = null;
$tmpIcons[$i]   = null;
$tmpEClass[$i]  = null;
