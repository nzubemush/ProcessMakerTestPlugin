Ext.namespace("stepmosheTest");

stepmosheTest.application = {
  init:function(){
    storeApplicationProcess = function () {
      ...
      Ext.Ajax.request({
        url: "../mosheTest/stepmosheTestApplicationAjax",
        method: "POST",
...
Ext.onReady(stepmosheTest.application.init, stepmosheTest.application);